...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  const csp = [
    ...
    // scripts: self + Astro inline + cdnjs (dom-to-image), Vercel analytics/insights, TikTok, X/Twitter widgets
    "script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://va.vercel-scripts.com https://cdn.vercel-insights.com https://www.googletagmanager.com https://www.google-analytics.com https://www.tiktok.com https://sf16-website-login.neutral.ttwstatic.com https://platform.twitter.com https://platform.x.com https://cdn.syndication.twimg.com https://platform.x.com/widgets.js",
    ...
    `img-src 'self' data: blob: https://abs.twimg.com https://ton.twimg.com ${IMAGE_SOURCES}`,
    ...
    `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://va.vercel-scripts.com https://vitals.vercel-insights.com https://cdn.vercel-insights.com https://www.google-analytics.com https://region1.google-analytics.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.syndication.twimg.com https://syndication.twitter.com https://syndication.x.com ${IMAGE_SOURCES}`,

    // manifests
    "manifest-src 'self'",

    // iframes
    "frame-src 'self' https://www.youtube.com https://www.facebook.com https://www.instagram.com https://www.tiktok.com https://platform.twitter.com https://platform.x.com https://syndication.twitter.com https://syndication.x.com https://twitter.com https://x.com",
